...
from individualized_pate.studies.parameters import ExperimentPlan, ExperimentParameters
from individualized_pate.data.data_factory import DataFactory
from individualized_pate.studies import train_teachers, run_votings, train_students
"""
...
def run_pate(params_path,
    ...
    #
    # potential TODO-reviews:- change the write splits, to be more standard
    #
...
def run_experiment_set(set_params_dir, data_dir, out_root_dir):
    ...
    for params_path in params_paths:
        ...
        process = Process(
            ...
            name=f'individualized-pate :{experiment_set_name}:{experiment_plan_name}'
        )
