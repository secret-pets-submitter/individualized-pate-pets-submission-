...
from individualized_pate.models.classifiers import Classifier, encode_one_hot
from individualized_pate.privacy.core import compute_logq_gaussian, _log1mexp
...
class VanishingGNMax(GNMax):
    ...
    def prepare(self, budgets, mapping):
        ...
        ## added by Adam, for weight changes
        #self.budgets_g = np.log(1 + np.array(self.budgets_g))
        ##
...
class WeightingGNMax(GNMax):
    ...
    def prepare(self, budgets, mapping):
        ...
        # Adam-  change the weighting scheme
        #budgets_t = np.sqrt(budgets_t)
