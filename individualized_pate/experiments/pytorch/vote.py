...
from individualized_pate.studies.parameters import ExperimentParameters, PATEParameters
from individualized_pate.models.pytorch.classifier_wrapper import ClassifierWrapper
from individualized_pate.privacy.pate import PATE, average_dp_budgets
...
def main(
        ...
        budgets_per_sample: Dict,  # TODO (jannis): Is this a dict?
        mapping_t2p: Dict,  # TODO (jannis): Is this a dict?
):
    # unpack public data
    ...
    # collect results
    # TODO (jannis): prms removed, log from caller
    # TODO (jannis): 'budgets_linear' removed, is it used at all?
    statistics = {
        ...
        # TODO (jannis): how does 'epsilons' differ from prms.budgets?
