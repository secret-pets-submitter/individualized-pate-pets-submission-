...
from individualized_pate.experiments.experiment_factory import ExperimentFactory
from individualized_pate.data.data_factory import DataFactory
from individualized_pate.studies.parameters import ExperimentParameters
from individualized_pate.privacy.pate import load_mappings
...
def main(prms: ExperimentParameters, data_factory: DataFactory):
    ...
    for i, (voting_seed, aggregator) in enumerate(combinations):
        ...
        # save features with predicted and true labels
        # TODO (jannis): data saved as npy instead data frame, good?
