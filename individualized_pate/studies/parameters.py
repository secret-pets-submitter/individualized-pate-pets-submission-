...
from individualized_pate.data.data_factory import DataFactory
import yaml
...
class DataParameters:
    ...
    data_name: Name of the dataset that will be used for the experiment.
        Available dataset names depend on the individualized_pate.data.DataFactory class.
...
class ModelParameters:
    ...
    architecture: Model architecture used for teachers and students, see individualized_pate.models.
        TODO: Currently, only pytorch models are usable, see individualized_pate.models.pytorch.pytorch_models.ARCHITECTURES
...
class ExperimentPlan:
    ...
    def _scale_for_uGNMax(
        ...
        duplications = set_duplications(
            # budgets=np.array(tmp_budgets),
            budgets=np.array(pate_prms.budgets),
