...
from individualized_pate.models.pytorch.pytorch_model import PytorchModel, PytorchModelArgs
from individualized_pate.data.data_augmentation import get_transform
from individualized_pate.models.pytorch.training import accuracy_by_class, evaluate, evaluate_precision, evaluate_recall, train_epoch, accuracy
from individualized_pate.models.classifiers import Classifier
from individualized_pate.data.numpy_dataset import NumpyDataset
...
class ClassifierWrapper(Classifier):
    ...
    def save(self, path):
        ...
        # TODO (jannis): clean up workaround to omit instance from pickle
        self.instance = None
