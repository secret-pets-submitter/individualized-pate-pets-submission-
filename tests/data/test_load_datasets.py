...
import numpy as np
from individualized_pate.data.load_datasets import load_cifar10, load_fashion_mnist, load_mnist, load_svhn
import pytest


def test_load_mnist():
    with TemporaryDirectory(prefix='tests_individualized_pate.') as d:
