...
BASE_OUT_DIR=/datadrive1/CleverHans/individualized_pate/pate_for_idpsgd/MNIST
BASE_OUT_DIR=/mfsnic/adam/idpsgd/roy/PATE/MNIST
...
YAML_DIR=/h/321/royrinberg/individualized-pate-pets-submission-/experiment_plans/set_6_reviewer_response/reproducing_pate_student/mnist_table_1
